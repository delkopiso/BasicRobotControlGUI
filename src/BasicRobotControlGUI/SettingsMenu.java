...
public class SettingsMenu extends JFrame {
    ...
    private final double xAbsoluteMin = -200;
    private final double yAbsoluteMin = -400;
    private final double zAbsoluteMin = 0;
    private final double aAbsoluteMin = -180;
    private final double bAbsoluteMin = -90;
    private final double cAbsoluteMin = -180;
    private final double xAbsoluteMax = 650;
    private final double yAbsoluteMax = 400;
    private final double zAbsoluteMax = 900;
    private final double aAbsoluteMax = 180;
    private final double bAbsoluteMax = 90;
    private final double cAbsoluteMax = 180;
